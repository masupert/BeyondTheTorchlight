# Town Creation
When setting off into the wilderness you will first need to set up a new town before you create your character. Each player at the table will contribute to the creation of a town by developing multiple characters/families. Players will then be able xto use any character they have created for adventuring. 
